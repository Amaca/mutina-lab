...
var ContextualTransition =
/*#__PURE__*/
function (_Highway$Transition) {
  _inherits(ContextualTransition, _Highway$Transition);

  function ContextualTransition() {
    _classCallCheck(this, ContextualTransition);

    return _possibleConstructorReturn(this, _getPrototypeOf(ContextualTransition).apply(this, arguments));
  }

  _createClass(ContextualTransition, [{
    key: "in",
    value: function _in(_ref) {
      ...
      to.style.top = '0';
      to.style.left = '0'; // Reset Scroll

      window.scrollTo(0, 0); // Animation

      _TweenLite.default.fromTo(to, 0.5, {
        opacity: 0
      }, {
        opacity: 1,
        onComplete: done
      ...
      _TweenLite.default.fromTo(from, 0.5, {
        opacity: 1
      }, {
        opacity: 0,
  ...
  return ContextualTransition;
}(_highway.default.Transition); // Don`t forget to export your transition


var _default = ContextualTransition;
exports.default = _default;

},{"@dogstudio/highway":1,"gsap/CSSPlugin":2,"gsap/TweenLite":3}],5:[function(require,module,exports){
"use strict";
...
},{"@dogstudio/highway":1}],6:[function(require,module,exports){
"use strict";
...
},{"@dogstudio/highway":1,"gsap/CSSPlugin":2,"gsap/TweenLite":3}],7:[function(require,module,exports){
"use strict";
...
var _contextualTransition = _interopRequireDefault(require("./highway/contextual-transition"));

var _customRenderer = _interopRequireDefault(require("./highway/custom-renderer"));

var _customTransition = _interopRequireDefault(require("./highway/custom-transition"));
...
function () {
  ...
  _createClass(Main, [{
    ...
    value: function init() {
      ...
      _dom.default.detect(body); //const lights1 = new Lights({ selector: '#canvas1' });
      ...
      var H = new _highway.default.Core({
        renderers: {
          name: _customRenderer.default
        },
        transitions: {
          name: _customTransition.default,
          contextual: {
            foo: _contextualTransition.default
          }
        }
      });
    }
...
},{"./highway/contextual-transition":4,"./highway/custom-renderer":5,"./highway/custom-transition":6,"./shared/dom":8,"@dogstudio/highway":1}],8:[function(require,module,exports){
"use strict";
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
